...
def ckpt_path(ckpt_dir, noise, cycles, p, seed="s1"):
    """체크포인트 경로 (dp0.001_... 형식)"""
    # noise = "realistic/dp0.001_mf0.01_rf0.01_gd0.008_id0.0"
    # -> "dp0.001_mf0.01_rf0.01_gd0.008_id0.0"
    noise_name = noise.split("/")[1]
    tag = f"d{DISTANCE}_c{cycles}_p{p}_{noise_name}_{seed}"
